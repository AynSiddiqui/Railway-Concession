              ...
              <div className="my-4">
                ...
                <div>
                  <input
                    type="password"
                    name="password"
                    className="my-2 shadow-lg appearance-none border rounded-2xl w-96 py-2 px-3 text-gray-700 leading-tight hover:bg-red-600 hover:text-white focus:outline-indigo-100 focus:shadow-outline"
